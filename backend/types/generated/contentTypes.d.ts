...
export interface ApiContactInquiryContactInquiry
  ...
  info: {
    description: 'Form submissions from website visitors';
...
export interface ApiHeroSlideHeroSlide extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Homepage banner slides';
  ...
  attributes: {
    buttonLink: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'projects.html'>;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['residential', 'commercial', 'landscape', 'single-home']
    > &
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Architecture & interior design services';
    displayName: 'Service';
    pluralName: 'services';
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    address: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'5609 E Sprague Ave, Spokane Valley, WA 99212, USA'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    phone: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'(+480) 123 678 900'>;
    publishedAt: Schema.Attribute.DateTime;
    siteTitle: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Antra Architecture & Interior Design'>;
    ...
    workingHours: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Mon - Fri: 9:00 AM - 6:00 PM'>;
  };
}
